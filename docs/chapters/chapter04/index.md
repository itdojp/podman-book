...
# 第4章：コンテナの基本操作とイメージ管理

## 本章の意義と学習目標

**なぜ基本操作を体系的に学ぶ必要があるのか**

「動かすだけなら簡単」というコンテナですが、本番環境で安定運用するには、各操作の意味と影響を深く理解する必要があります。理由は次のとおりです。
...
コンテナの状態遷移を理解することで、次のことが可能になります。
...
コンテナは様々な用途で使用され、それぞれに最適な設定が異なります。主なパターンは次のとおりです。
...
<a id="figure-image-pull-inventory"></a>
...
- コンテナのライフサイクルと、用途に応じた実行オプションの使い分けを整理しました。
- イメージの取得・管理、コンテナ内での作業（exec/cp など）、ログ/モニタリングの基本を確認しました。
- トラブルシューティングの基本手順と、よくある問題の切り分け観点を示しました。

## 次に読む

- [第5章：Containerfileとイメージビルド・配布](../chapter05/)
- [目次に戻る](../../)
